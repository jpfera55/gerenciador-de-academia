...
public class CadastraExercicio extends javax.swing.JPanel {
    ...
    private static Aparelho verificaSeAparelhoExiste(String nomeDoAparelho){
                Iterator iterador2 = ControladorPrincipal.aparelhos.iterator();
    ...
    public  void adicionaAparelhosNaLista(){
        ...
        listDeAparelhos.add( ControladorPrincipal.aparelhos.get(c).getNome());
        }
    ...
    private void jButtonVoltarActionPerformed(java.awt.event.ActionEvent evt) {                                              
       ...
       jTextFieldGrupoMuscular.setText("");
       jTextFieldNomeDoExercicio.setText("");
       listDeAparelhos.removeAll();
       listDeGrupoMuscular.removeAll();
    }                                             

    private void listDeAparelhosMouseMoved(java.awt.event.MouseEvent evt) {                                           
       
    }                                          

    private void listDeAparelhosComponentShown(java.awt.event.ComponentEvent evt) {                                               
       

    }                                              

    private void jButtonVerAparelhosActionPerformed(java.awt.event.ActionEvent evt) {                                                    
    ...
    private void jButtonVerGrupoMuscularActionPerformed(java.awt.event.ActionEvent evt) {                                                        
